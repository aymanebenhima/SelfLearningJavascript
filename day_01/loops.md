...
1. Extract all the countries contain the word 'land' from the [countries array](https://github.com/aymanebenhima/SelfLearningJavascript/tree/main/data/countries.js) and print it as array
1. Find the country containing the hightest number of characters in the [countries array](https://github.com/aymanebenhima/SelfLearningJavascript/tree/main/data/countries.js)
1. Extract all the countries contain the word 'land' from the [countries array](https://github.com/aymanebenhima/SelfLearningJavascript/tree/main/data/countries.js) and print it as array
1. Extract all the countries containing only four characters from the [countries array](https://github.com/aymanebenhima/SelfLearningJavascript/tree/main/data/countries.js) and print it as array
1. Extract all the countries containing two or more words from the [countries array](https://github.com/aymanebenhima/SelfLearningJavascript/tree/main/data/countries.js) and print it as array
1. Reverse the [countries array](https://github.com/aymanebenhima/SelfLearningJavascript/tree/main/data/countries.js) and capitalize each country and stored it as an array
